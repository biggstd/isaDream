...
class DrupalNode:
    ...
    **Outline of Dataflow**:
    ...
    def __init__(self, node_json_path):
        ...
        self.study_assays = self.normalize_to_dataframe(self.json_dict, 'assays')
    ...
    def metadata(self):
        ...
        secondary_metadata = {
            'node_info': [vals[-1] for vals in self.__node_information.groupby(level=0)],
            'study_factors': [vals[-1] for vals in self.__study_factors.groupby(level=0)],
            'study_samples': [vals[-1] for vals in self.__study_samples.groupby(level=0)],
            'study_comments': [vals[-1] for vals in self.__study_comments.groupby(level=0)],
        }
